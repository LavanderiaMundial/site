      ...
      <div className="flex flex-col md:flex-row md:h-[600px]">
        ...
        <div className="w-screen px-5 md:w-1/2 md:pl-16">
          ...
          <p className="text-base text-black/75">
            Para manter os estofados sempre limpos e bonitos, é importante
            realizar uma limpeza regular. No entanto, em alguns casos, a limpeza
            doméstica pode não ser suficiente para remover as manchas mais
            difíceis ou para eliminar ácaros e bactérias, que podem causar
            alergias. Nesses casos, é recomendado contratar um serviço de
            limpeza profissional de estofados e a Lavanderia Mundial é a mais
            recomendada. Somos uma lavanderia de estofados especializada que
            conta com equipamentos e produtos específicos para limpeza profunda
            de móveis e estofados, além de profissionais qualificados para
            realizar o serviço de forma segura e eficaz.
          </p>
        ...
        <div className="hidden md:flex flex-col items-center md:w-1/2 md:-mt-28 z-10">
          ...
          <div className="relative w-96">
            <Image
              src={fotoSofaTopo}
              alt="foto de uma família feliz sentada em um sofá limpo"
              width={384}
