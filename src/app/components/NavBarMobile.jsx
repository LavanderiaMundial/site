...
export default function NavMobile() {
    ...
    return (
        <div className='flex justify-around md:hidden mt-5'>
            ...
            <div
                className={`text-light fixed  right-0 top-0 z-40 flex h-full w-[70vw]  flex-col backdrop-blur-md bg-gradient-to-t from-primary to-secondary transition-all duration-1000 ease-in-out ${showSidebar ? 'translate-x-0 ' : 'translate-x-full'
                    }`}
            >
                <button
